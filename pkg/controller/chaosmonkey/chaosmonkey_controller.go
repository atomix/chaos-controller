...
import (
	...
	chaosv1alpha1 "github.com/atomix/chaos-operator/pkg/apis/chaos/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &chaosv1alpha1.ChaosMonkey{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &chaosv1alpha1.ChaosMonkey{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileChaosMonkey) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &chaosv1alpha1.ChaosMonkey{}
...
func newPodForCR(cr *chaosv1alpha1.ChaosMonkey) *corev1.Pod {
